...
const div = () => {
  ...
  return (
<div className={`${currentTheme === "dark" ? "bg-gray-800 text-gray-100" : "bg-white text-black"}`}>
<div className=" p-10 text-center flex flex-col space-y-5 justify-center items-center">
