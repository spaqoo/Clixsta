...
const page = () => {
  return (
    <main>
      <div className="p-10 lg:px-20 py-10 grid grid-cols-1 lg:grid-cols-2 pt-32 gap-20  md:h-[100vh]">
        <div className="space-y-5 flex flex-col justify-start">
          ...
          <ul className="flex gap-5">
            <Button className="p-3 bg-red-500 px-6 rounded">View Plans & Pricing</Button>
            <Button className="p-3 border-2 px-6 rounded">Custom Quot</Button>
          </ul>
      ...
      <section className="p-10 md:p-44 space-y-5">
      ...
      <section className="flex flex-col md:flex-row items-center md:p-10 gap-20">
        <div className="md:w-2/6">
          <img src="https://www.artimization.com/wp-content/uploads/2019/12/custom-website-1.jpg" className="h-full" />
        </div>
        <div className="p-10 md:w-4/6 space-y-5">
      ...
      <section className="p-10 md:p-44 space-y-5">
        ...
        <div className="flex gap-5 items-center">
          <Button className="bg-black text-white rounded p-4 px-6 text-md">View Plans & Pricing</Button>
          <Button className="bg-transparent rounded p-4 px-6 text-md text-red-500"> Request A Custom Quote </Button>
        </div>
      </section>
      ...
      <section className="md:p-20 grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <section className="p-10 grid grid-cols-1 md:grid-cols-3">
      ...
      <section className="p-10 md:p-20 grid gird-col-1 md:grid-cols-3">
      ...
      <section className="p-10 md:p-20 grid grid-c0l-1 md:grid-cols-3">
        <div className="flex  items-center">
          <div className="text-4xl font-semibold">
            Platforms
          </div>
      ...
      {/* section */}
      <div className="flex flex-col p-5 md:flex-row items-center md:px-20 gap-10">
        ...
        <div className="p-10 space-y-5 md:w-3/5">
      ...
      <section className="p-10 md:p-44 space-y-5">
        ...
        <div className="flex gap-5 items-center">
          <Button className="bg-black text-white rounded p-4 px-6 text-md">View Plans & Pricing</Button>
          <Button className="bg-transparent rounded p-4 px-6 text-md shadow-none hover:shadow-none text-red-500"> Request A Custom Quote </Button>
        </div>
      </section>
      ...
      <section className="p-10 md:p-10">
        <div className="md:p-20 md:px-32 space-y-5 text-center border">
          <div className="text-4xl font-semibold">
          ...
          <div className="flex gap-3">
            <Button className="p-3 w-full rounded bg-red-500 text-white text-semibold">VIEW PLANS & PRICING</Button>
            <Button className="p-3 w-full rounded border-2 text-white text-semibold">CUSTOM QUOTE</Button>
          </div>
        </div>
      </section>
      ...
      <div className="p-10 md:p-20 flex flex-col md:justify-center md:items-center md:space-y-5">
        <div className="text-5xl font-semibold">
          Our Latest Website Layout
        </div>
        <div className="text-lg text-center md:w-4/6">
        ...
        <div className="grid grid-col-1 md:grid-cols-4 py-10 gap-3">

          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/anaj-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/ashray-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/matrix-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/tradify-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cbd-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cbd-1-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/shanti-1-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cosmia-1-300x204.jpg')] p-20 lg:p-32 rounded bg-no-repeat bg-cover bg-center"></div>
      ...
      <div className="p-10 md:px-20 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
