...
const page = () => {
  return (
    <main>
      ...
      <section className="px-10 md:p-44 space-y-5">
        <div className="text-3xl font-semibold w-5/6">
        ...
        <div className="text-xl text-gray-500  w-5/6">
      ...
      <section className="px-10 md:p-44 space-y-5">
        ...
        <div className="text-md text-gray-500  w-5/6">
      ...
      <section className="p-20 grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <section className="p-5 md:p-20 grid md:grid-cols-3">
        ...
        <div className="text-lg text-gray-800 w-4/5 flex justify-center items-center">
      ...
      <section className="p-10">
        <div className="p-5 md:p-20 md:px-32 space-y-5 text-center border">
          <div className="text-4xl font-semibold">
      ...
      <div className=" p-10 md:px-20 md:py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
